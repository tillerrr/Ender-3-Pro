...
#define STRING_CONFIG_H_AUTHOR "(tillerrr, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tiller's Slave"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 400.57 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.50, 6.0, -1.15 }
...
#define INVERT_E0_DIR false //BMG CLONE
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 26.4, 26.4, 26.4, 26.4 } // (mm) Left, Front, Right, Back insets
   ...
   */
  #define BED_TRAMMING_LEVELING_ORDER { LF, LB, RB, RF }
#endif
